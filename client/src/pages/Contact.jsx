...
const contactInfo = [
  ...
  { Icon: Mail, title: 'Email', lines: ['info@apexfitness.co.in', 'support@apexfitness.co.in'] },
        ...
        <div className="container relative">
          <ScrollReveal>
            ...
            <p className="text-muted text-lg max-w-xl leading-relaxed">
              Visit Apex Fitness in Anand or Nadiad, book a free trial class, or enquire about membership plans.
            </p>
          </ScrollReveal>
        </div>
      </section>
            ...
            <div>
              ...
              <div className="flex flex-col gap-4 mb-8">
                {contactInfo.map(({ Icon, title, lines }) => (
                  <div key={title} className="card flex items-start gap-4 p-5 h-full">
              ...
              {sent ? (
                <div className="text-center py-10">
                  ...
                  <p className="text-muted text-sm max-w-xs mx-auto leading-relaxed">
                    Thank you! Our team will be in touch within 24 hours to schedule your free trial at Apex Fitness.
                  </p>
                  <button onClick={() => setSent(false)} className="btn-outline mt-7 mx-auto">Send Another</button>
                </div>
              ) : (
                <>
                  <h2 className="text-2xl font-bold mb-2">Book a <span className="text-accent">Free Trial</span></h2>
