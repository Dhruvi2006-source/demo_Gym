...
const programs = [
  {
    ...
    desc: 'CrossFit at Apex Fitness combines strength training and cardiovascular conditioning in high-intensity workouts. Each session is scalable for all fitness levels.',
      ...
      <section className="py-20 text-center" style={{ background: 'linear-gradient(180deg, #0a0e18 0%, #06080d 100%)' }}>
        <div className="container">
          <ScrollReveal>
            ...
            <p className="section-subtitle mx-auto mb-10">Our expert coaches will help you find the perfect program for your goals and fitness level at Apex Fitness.</p>
